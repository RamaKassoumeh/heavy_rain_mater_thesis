...
test_file_name='/home/gouda/heavyrain/RadarData_summer_20/'

test_data = RadarFilterRainNetSatelliteDataset(
    img_dir=test_file_name,
    sat_dir='/home/gouda/heavyrain/SatelliteData_summer_20',
...
model=RainNet()
test_metrics.test_phase(file_name,model,test_data,test_file_name,batch_size=2)